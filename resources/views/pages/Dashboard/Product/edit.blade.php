    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{ route('dashboard.product.update', $items->id) }}" class="w-full " method="post"
                    ...
                    <div class="flex flex-wrap mb-6 -mx-3 ">
                        <div class="w-full px-3 mt-3 mb-6">
                            ...
                            <input type="text" value="{{ old('nama') ?? $items->name }}" name="name"
                        ...
                        <div class="w-full px-3 mt-3 mb-6">
                            ...
                            <input type="number" value="{{ old('price') ?? $items->price }}" name="price"
                                class="block w-full px-4 py-3 text-gray-700 bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:bg-gray-500"
