...
@section('section')
    ...
    <section class="flex items-center hero">
        <div class="absolute inset-0 z-20 flex flex-col justify-center w-full text-center md:relative md:w-1/2 hero-caption">
            ...
            <div>
                <a href="#browse-the-room"
                    class="flex-none inline-block px-8 py-3 mt-4 text-black transition duration-200 bg-pink-400 rounded-full hover:bg-black hover:text-pink-400">Explore
                    Now</a>
            </div>
        </div>
        <div class="inset-0 w-full md:relative md:w-1/2">
            <div class="relative hero-image">
                ...
                <div class="bottom-0 right-0 overlay md:inset-0">
                    <button class="z-30 video hero-cta focus:outline-none modal-trigger"
    ...
    <section class="container mx-auto">
        <div class="flex flex-wrap justify-center">
            <div class="flex-auto w-full px-4 my-4 md:w-auto md:flex-initial md:px-6 md:my-0">
